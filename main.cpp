...
//Defining our matrices here. We are multiplying a and b matrices and creating c matrix
int a[M_SIZE][M_SIZE];
int b[M_SIZE][M_SIZE];
int c[M_SIZE][M_SIZE];

//Random number generator which will give random numbers
int GenerateRandomNumber(){
	return std::rand() % 9 + 1;
}

template<int rows, int cols>
//We are filling our matrix with random numbers to create input matrixes
